    ...
    render(){
        return(
            <div>
                ...
                <form className="w-full max-w-xl mx-auto" onSubmit={this.handleSubmit} onError={this.handleSubmit}>
                    <div className="flex items-center border-b-2 border-red-500 py-2">
                        <input className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" 
                        type="text" placeholder="Enter YouTube video link" aria-label="Full name" 
